...
final class AddStoreAppViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        appImagePlaceholderView.addDashedBorder(color: .systemGray, cornerRadius: 10)
        ...
        idField.placeholder = "Store ID of the app"
    ...
    func populateUI(appResult: AppResult?) {
        ...
        guard let appResult = appResult else {
            ...
            self.appNameLabel.textColor = .quaternaryLabel
            self.addButton.isEnabled = false
            return
        }
        
        self.appNameLabel.textColor = .label
